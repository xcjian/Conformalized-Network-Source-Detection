...
python main_SIR_T_pyt.py --gt ${gt} --n_node ${N} --n_frame ${nf} --batch_size ${bs} --epoch ${ep} --ks ${ks} --kt ${kt} --sconv ${sc} --save ${save} --graph $g --pred $p --seq $s --exp_name $exp_name --start ${skip} --end ${end} --random ${random}\
    --lr ${lr}
