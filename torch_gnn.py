...
data_file = 'SIR_nsrc1_Rzero2.5_beta0.25_gamma0_T30_ls21200_nf16_torchentire_with_node_features.pickle'
...
# Data preparation
n_frame = 16
X = data[0]  # List of 21200 tensors, each (3, 774)
y = data[1]  # Shape: (21200,)
skip = data[2]
X = [torch.tensor(x.T, dtype=torch.float32) for x in X]  # Convert to tensors without slicing and skip
